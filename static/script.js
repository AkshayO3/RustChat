...
function init() {
    ...
    addRoom("VIT");
    changeRoom("Ramgarh");
    addMessage("Ramgarh", "Dexter", "For popping the nostalgia,huh.", true);
    addMessage("VIT", "Dexter", "To show the college acquaintances.", true);
    ...
    newRoomForm.addEventListener("submit", (e) => {
        ...
        addMessage(room, "Dexter", `Voila,your room has been brought into existence!`, true);
    })
